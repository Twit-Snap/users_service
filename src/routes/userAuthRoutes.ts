...
router.post('/forgot-password', (req, res, next) => new UserAuthController().forgotPassword(req, res, next));
router.post('/reset-password', (req, res, next) => new UserAuthController().resetPassword(req, res, next));
